...
import { ArrowLeft, BadgeCheck, Mail, Phone, Save, UserRound } from "lucide-react";
...
const DEFAULT_PROFILE: Profile = { full_name: "Sahil Bhatia", tech_id: "X2002709", afl_email: "sahil.bhatia@aflglabal.com", telus_email: "sahil.bhatia1@telus.com", contact_number: "", bio: "Fibre sales and customer experience professional." };
...
export function ProfileClient() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      setProfile({ ...DEFAULT_PROFILE, ...saved, full_name: saved.full_name || DEFAULT_PROFILE.full_name, tech_id: saved.tech_id || DEFAULT_PROFILE.tech_id, afl_email: saved.afl_email || DEFAULT_PROFILE.afl_email, telus_email: saved.telus_email || DEFAULT_PROFILE.telus_email });
    };
