...
export function BestPlans() {
  ...
  const cards = plans.length ? plans : [{ id: "upload", name: "Upload current offers", category: "Offer sheets", price: "Build your plan library", summary: "Import TELUS Excel sheets for accurate plan lookup." }, { id: "compare", name: "Feature your best plan", category: "Smart recommendations", price: "Choose up to two", summary: "Star plans to keep the strongest offers on your dashboard." }];
